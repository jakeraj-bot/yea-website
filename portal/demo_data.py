...
ADMIN_REPORTS = [
    ...
    {
        "name": "Billing ledger",
        "description": "Every charge, payment, credit, and discount across all units",
        "format": "PDF / CSV",
        "slug": "ledger",
        "report": "ledger",
    },
    ...
    {
        "name": "Billing plans",
        "description": "Every child's plan — filter by name, school, or payment type",
        "format": "PDF / CSV",
        "slug": "plans",
        "report": "plans",
    },
    {
        "name": "Missing billing plans",
        "description": "Active children with no plan or no weekly amount",
        "format": "PDF / CSV",
        "slug": "missing-plans",
    ...
    {
        "name": "Scholarship assignments",
        "description": "Scholarship types assigned to children, with full rate and family portion",
        "format": "PDF / CSV",
        "slug": "scholarships",
        "report": "scholarships",
    },
    {
        "name": "Scheduled plan charges",
        "description": "Auto-charge plans and the next charge date",
        "format": "PDF / CSV",
        "slug": "scheduled",
        "report": "scheduled",
    },
