...
GUIDES = {
    ...
    "reports": {
        ...
        "steps": [
            ...
            {
                "title": "Exports",
                "body": "Outstanding balances and 4Cs copay files download as CSV for spreadsheets. Who still owes — by week lists unpaid weeks and lets you charge a $15 late fee only on the children you check.",
            },
        ],
    },
    "owed-weeks": {
