    ...
    "activity-calendar": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "body": "Filter the left list by school attending, grade, child name, and by group (bus run, room, and other groups from the Groups page). Admins can also filter by unit. Staff only see children and activities at their unit.",
            },
        ],
    },
