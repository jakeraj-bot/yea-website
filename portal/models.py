...
class PortalPayment(models.Model):
    ...
    stripe_bank_status = models.CharField(max_length=64, blank=True)
    stripe_bank_date = models.DateField(null=True, blank=True)
    stripe_settlement_checked_at = models.DateTimeField(null=True, blank=True)
    stripe_payout_id = models.CharField(max_length=255, blank=True)
    stripe_payout_descriptor = models.CharField(max_length=255, blank=True)
    stripe_payout_amount = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
